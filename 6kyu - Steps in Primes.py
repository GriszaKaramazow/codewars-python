...
# if these g-steps prime numbers exist otherwise nil or null or None or Nothing or [] or "0, 0" or {0, 0} (depending on
# the language).
#
# #Examples:
#
...
#
# step(6, 100, 110) --> [101, 107] though there is a prime between 101 and 107 which is 103; the pair 101-103 is a
# 2-step.
#
# #Notes: The idea of "step" is close to that of "gap" but it is not exactly the same. For those interested they can
# have a look at http://mathworld.wolfram.com/PrimeGaps.html.
#
# A "gap" is more restrictive: there must be no primes in between (101-107 is a "step" but not a "gap". Next kata will
# be about "gaps":-).
#
...
for test in tests:
    test_outcome = step(test[0], test[1], test[2])
